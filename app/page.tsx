...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#100000] to-[#500000] flex items-center justify-center p-4 md:p-6 lg:p-10 font-sans">
              ...
              {showAbout && (
                <div className="mt-6 mb-4 bg-black/85 backdrop-blur-md border border-white/20 p-6 md:p-8 rounded-3xl max-w-2xl text-white transition-all duration-500 shadow-2xl">
                  ...
                  <p className="text-sm text-gray-200 leading-relaxed mb-4">
                    Platform resmi siswa SMA Negeri 1 Soe untuk menyalurkan kritik, saran, dan ide kreatif secara aman, transparan, dan privat langsung kepada pengurus OSIS. Dan dikelola secara profesional oleh Sekbid Aspirasi serta kerja sama antara Ketua Osis dan Wakil Ketua Osis SMAN 1 Soe.
                  </p>
