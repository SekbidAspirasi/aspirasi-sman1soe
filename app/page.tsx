...
{showAbout && (
  <div className="mt-6 bg-black/80 backdrop-blur-md border border-white/20 p-6 md:p-8 rounded-3xl max-w-2xl text-white transition-all duration-500 shadow-2xl">
    ...
    <p className="text-sm text-gray-200 leading-relaxed mb-4">
      Platform resmi siswa SMA Negeri 1 Soe untuk menyalurkan kritik, saran, dan ide kreatif secara aman, transparan, dan privat langsung kepada pengurus OSIS dan dikelola secara profesional oleh pengurus Sekbid 6 serta Ketua dan Wakil Ketua Osis SMAN 1 Soe.
    </p>
